...
% read figure code
<<figures, include=FALSE, echo=FALSE>>=
...
<<boxplot_igaussian_res1_prior_mean, cache=FALSE, echo=FALSE, fig.cap="Prior mean estimates", out.width="80%", fig.align="center", fig.asp=2/3>>=
@

<<boxplot_igaussian_res2_prior_mean, cache=FALSE, echo=FALSE, fig.cap="Prior mean estimates", out.width="80%", fig.align="center", fig.asp=2/3>>=
@
