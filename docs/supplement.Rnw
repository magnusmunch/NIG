...
<<"boxplot_igaussian_res1_sigma2", fig.cap="MSEs for posterior means of $\\sigma_d^2$ in simulation 1", out.width="50%", fig.align="center", echo=FALSE>>=
...
<<"boxplot_igaussian_res1_gamma2", fig.cap="a) MSE and b) correlation for posterior means of $\\gamma_d^2$ in simulation 1", fig.align="center", echo=FALSE>>=
res1 <- read.table("../results/simulations_igaussian_res1.csv")
set1 <- read.table("../results/simulations_igaussian_set1.csv")
names1 <- c("inv Gauss", "ind inv Gauss", "inv Gamma")
...
<<"boxplot_igaussian_res1_mu", fig.cap="a) MSE and b) correlation for posterior means of $\\beta_d$ in simulation 1", fig.align="center", echo=FALSE>>=
res1 <- read.table("../results/simulations_igaussian_res1.csv")
names1 <- c("inv Gauss", "ind inv Gauss", "inv Gamma")
...
<<"boxplot_igaussian_res1_theta", fig.cap="a) MSE and b) correlation for prior means of $\\gamma_d^2$ ($\\theta_d$) in simulation 1", fig.align="center", echo=FALSE>>=
res1 <- read.table("../results/simulations_igaussian_res1.csv")
set1 <- read.table("../results/simulations_igaussian_set1.csv")
names1 <- c("inv Gauss", "ind inv Gauss", "inv Gamma")
...
<<"boxplot_igaussian_res1_alpha", fig.cap="a) MSE and b) correlation for $\\alpha$ in simulation 1", fig.align="center", echo=FALSE>>=
res1 <- read.table("../results/simulations_igaussian_res1.csv")
set1 <- read.table("../results/simulations_igaussian_set1.csv")
...
<<"lines_igaussian_res1_elbo", fig.cap="Convergence of ELBO for a) inverse Gaussian, b) independent inverse Gaussian, and c) inverse Gamma models in simulation 1", fig.align="center", echo=FALSE>>=
...
<<"lines_igaussian_res1_theta", fig.cap="Convergence of prior means for a) inverse Gaussian, b) independent inverse Gaussian, and c) inverse Gamma models in simulation 1", fig.align="center", echo=FALSE>>=
fit1 <- read.table("../results/simulations_igaussian_fit1.csv")
set1 <- read.table("../results/simulations_igaussian_set1.csv")
...
<<"boxplot_igaussian_res2_theta", fig.cap="a) MSE and b) correlation for prior means of $\\gamma_d^2$ ($\\theta_d$) in simulation 2", out.width="50%", fig.align="center", echo=FALSE>>=
...
<<"lines_igaussian_res2_alpha", fig.cap="Convergence of $\\alpha$ for a) inverse Gaussian and b) independent inverse Gaussian in simulation 2", fig.align="center", echo=FALSE>>=
